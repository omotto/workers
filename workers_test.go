...
func TestPoolError(t *testing.T) {
	...
	if id2, err = pool.AddWorker(true, func(name string, age int8) (string, error) {
		return fmt.Sprintf("%s  %d years old", name, age), errors.New("fake error")
	}, "pepe", int8(34)); err != nil {
		t.Error(err)
		return
	}
